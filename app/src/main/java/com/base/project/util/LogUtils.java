...
import com.base.project.Factory;
...
//        }
        ...
        synchronized(LogUtils.class){
            String path = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"wakaicloud"+ File.separator;
            if(Factory.get().getApplicationContext()!=null){
            	File externalFilesDir = Factory.get().getApplicationContext().getExternalFilesDir(null);
            ...
            try {
                ...
                out.println(dateFormat.format(new Date(System.currentTimeMillis())) +"sdkversion:"+  "	" + priority
                        + "	" + ">>" + tag + "<<    	" + msg + '\r');
                outPutStream.flush();
    ...
    public static void mkdirectory(String file) {
